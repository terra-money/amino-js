...
import (
	crypto "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/crypto"
	keys "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/crypto/keys"
	hd "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/crypto/keys/hd"

	types "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/types"

	auth "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/auth"
	bank "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/bank"
	crisis "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/crisis"
	distribution "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/distribution/types"
	gov "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/gov/types"
	ibc "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/ibc"
	params "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/params/types"
	slashing "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/slashing"
	staking "github.com/terra-project/amino-js/go/lib/cosmos/cosmos-sdk/x/staking/types"

	tm_crypto "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/crypto"
	tm_ed25519 "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/crypto/ed25519"
	tm_multisig "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/crypto/multisig"
	tm_secp256k1 "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/crypto/secp256k1"

	tm_blockchain "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/blockchain"
	tm_consensus "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/consensus"
	tm_evidence "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/evidence"
	tm_mempool "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/mempool"
	tm_conn "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/p2p/conn"
	tm_pex "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/p2p/pex"
	tm_privval "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/privval"
	tm_types "github.com/terra-project/amino-js/go/lib/tendermint/tendermint/types"
...
func RegisterCodec(codec *amino.Codec) {
	...
	codec.RegisterConcrete(bank.MsgSend{}, TerraMsgSend, nil)
	codec.RegisterConcrete(bank.MsgMultiSend{}, TerraMsgMultiSend, nil)

	// cosmos/cosmos-sdk/x/crisis/codec.go

	codec.RegisterConcrete(crisis.MsgVerifyInvariant{}, TerraMsgVerifyInvariant, nil)

	// cosmos/cosmos-sdk/x/distribution/types/codec.go

	codec.RegisterConcrete(distribution.MsgWithdrawDelegatorReward{}, TerraMsgWithdrawDelegationReward, nil)
	codec.RegisterConcrete(distribution.MsgWithdrawValidatorCommission{}, TerraMsgWithdrawValidatorCommission, nil)
	codec.RegisterConcrete(distribution.MsgSetWithdrawAddress{}, TerraMsgModifyWithdrawAddress, nil)

	// cosmos/cosmos-sdk/x/gov/types/codec.go

	codec.RegisterInterface((*gov.Content)(nil), nil)

	codec.RegisterConcrete(gov.MsgSubmitProposal{}, TerraMsgSubmitProposal, nil)
	codec.RegisterConcrete(gov.MsgDeposit{}, TerraMsgDeposit, nil)
	...
	codec.RegisterConcrete(ibc.MsgIBCTransfer{}, TerraMsgIBCTransfer, nil)
	codec.RegisterConcrete(ibc.MsgIBCReceive{}, TerraMsgIBCReceive, nil)

	// cosmos/cosmos-sdk/x/params/types/codec.go

	codec.RegisterConcrete(params.ParameterChangeProposal{}, TerraParameterChangeProposal, nil)

	// cosmos/cosmos-sdk/x/slashing/codec.go

	codec.RegisterConcrete(slashing.MsgUnjail{}, TerraMsgUnjail, nil)

	// cosmos/cosmos-sdk/x/staking/types/codec.go

	codec.RegisterConcrete(staking.MsgCreateValidator{}, TerraMsgCreateValidator, nil)
	codec.RegisterConcrete(staking.MsgEditValidator{}, TerraMsgEditValidator, nil)
	codec.RegisterConcrete(staking.MsgDelegate{}, TerraMsgDelegate, nil)
	codec.RegisterConcrete(staking.MsgUndelegate{}, TerraMsgUndelegate, nil)
	codec.RegisterConcrete(staking.MsgBeginRedelegate{}, TerraMsgBeginRedelegate, nil)
