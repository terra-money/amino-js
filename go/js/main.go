...
func main() {
	...
	exports.Set("encodeCommunityPoolSpendProposal", EncodeCommunityPoolSpendProposal)
	...
	exports.Set("decodeCommunityPoolSpendProposal", DecodeCommunityPoolSpendProposal)
